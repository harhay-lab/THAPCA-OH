...
so0.02 <- mean(diff_so > 0.02)
so0.05 <- mean(diff_so > 0.05)
so0.10 <- mean(diff_so > 0.1)
so0.15 <- mean(diff_so > 0.15)
...
mo0.02 <- mean(diff_mo > 0.02)
mo0.05 <- mean(diff_mo > 0.05)
mo0.10 <- mean(diff_mo > 0.1)
mo0.15 <- mean(diff_mo > 0.15)
...
wo0.02 <- mean(diff_wo > 0.02)
wo0.05 <- mean(diff_wo > 0.05)
wo0.10 <- mean(diff_wo > 0.1)
wo0.15 <- mean(diff_wo > 0.15)
...
sn0.02 <- mean(diff_sn > 0.02)
sn0.05 <- mean(diff_sn > 0.05)
sn0.10 <- mean(diff_sn > 0.1)
sn0.15 <- mean(diff_sn > 0.15)
...
mn0.02 <- mean(diff_mn > 0.02)
mn0.05 <- mean(diff_mn > 0.05)
mn0.10 <- mean(diff_mn > 0.1)
mn0.15 <- mean(diff_mn > 0.15)
...
wn0.02 <- mean(diff_wn > 0.02)
wn0.05 <- mean(diff_wn > 0.05)
wn0.10 <- mean(diff_wn > 0.1)
wn0.15 <- mean(diff_wn > 0.15)
...
sp0.02 <- mean(diff_sp > 0.02)
sp0.05 <- mean(diff_sp > 0.05)
sp0.10 <- mean(diff_sp > 0.1)
sp0.15 <- mean(diff_sp > 0.15)
...
mp0.02 <- mean(diff_mp > 0.02)
mp0.05 <- mean(diff_mp > 0.05)
mp0.10 <- mean(diff_mp > 0.1)
mp0.15 <- mean(diff_mp > 0.15)
...
wp0.02 <- mean(diff_wp > 0.02)
wp0.05 <- mean(diff_wp > 0.05)
wp0.10 <- mean(diff_wp > 0.1)
wp0.15 <- mean(diff_wp > 0.15)
...
df <- data.frame("Prior Belief" = c("Optimistic", "", "",
                 ...
                 "Median" = c(paste(round(wo_med_d, 2), " (",
                                    round(wo_low_d, 2), ", ",
                                    round(wo_up_d, 2), ")", sep = ""),
                              paste(round(mo_med_d, 2), " (",
                                    round(mo_low_d, 2), ", ",
                                    round(mo_up_d, 2), ")", sep = ""),
                              paste(round(so_med_d, 2), " (",
                                    round(so_low_d, 2), ", ",
                                    round(so_up_d, 2), ")", sep = ""),
                              paste(round(wn_med_d, 2), " (",
                                    round(wn_low_d, 2), ", ",
                                    round(wn_up_d, 2), ")", sep = ""),
                              paste(round(mn_med_d, 2), " (",
                                    round(mn_low_d, 2), ", ",
                                    round(mn_up_d, 2), ")", sep = ""),
                              paste(round(sn_med_d, 2), " (",
                                    round(sn_low_d, 2), ", ",
                                    round(sn_up_d, 2), ")", sep = ""),
                              paste(round(wp_med_d, 2), " (",
                                    round(wp_low_d, 2), ", ",
                                    round(wp_up_d, 2), ")", sep = ""),
                              paste(round(mp_med_d, 2), " (",
                                    round(mp_low_d, 2), ", ",
                                    round(mp_up_d, 2), ")", sep = ""),
                              paste(round(sp_med_d, 2), " (",
                                    round(sp_low_d, 2), ", ",
                                    round(sp_up_d, 2), ")", sep = "")),
